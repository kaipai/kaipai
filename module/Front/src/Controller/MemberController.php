...
class MemberController extends Front{
    ...
    public function postComplainAction(){
        ...
        $this->memberOrderModel->update(array('isComplained' => 1, 'complainContent' => $complainContent), array('orderID' => $orderID, 'memberID' => $this->memberInfo['memberID']));
        ...
        if(empty($this->postData)){
            ...
            if(!empty($this->postData['specialID'])){
                ...
                if(!empty($this->postData['startTime']) && !empty($this->postData['endTime'])){
                    $this->productModel->update(array('startTime' => $this->postData['startTime'], 'endTime' => $this->postData['endTime']), array('specialID' => $this->postData['specialID']));
                }
