...
define("SDK_SIGN_CERT_PATH",__DIR__.'/key/unionpay.pfx');

// 签名证书密码
const SDK_SIGN_CERT_PWD = 'che123';

// 验签证书
define("SDK_VERIFY_CERT_PATH",__DIR__.'/key/UpopRsaCert.cer');
// 密码加密证书（这条用不到的请随便配）
define("SDK_ENCRYPT_CERT_PATH", __DIR__ . "/key/verify_sign_acp.cer");
// 验签证书路径（请配到文件夹，不要配到具体文件）
define("SDK_VERIFY_CERT_DIR", __DIR__ . "/key/");
...
//文件下载目录 
const SDK_FILE_DOWN_PATH = './key';

//日志 目录 
const SDK_LOG_FILE_PATH = './key';
